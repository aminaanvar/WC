  ...
  if(!empty($_POST['g-recaptcha-response']))
  {
    ...
    if (isset($_POST['signup'])) {
       ...
       if (!$error) {
            ...
            if(mysqli_query($conn, "INSERT INTO users(date,organisation,officename,address,district,lsgtype,lsgbody,ward,latlon,cpersonname, designation,caddress,cpersonnumber, cpersonemail) VALUES(now(),'" . $organisation . "','" . $officename . "', '" . $address . "','" . $district . "', '" . $lsgtype . "','" . $lsgbody . "','" . $ward . "','" . $latlon . "', '" . $cpersonname . "','" . $designation . "','" . $caddress . "','" . $cpersonnumber . "', '" . $cpersonemail . "')")) {
                ...
                <div class="col-md-10 pt-5 pb-5 bg-gray-50" style="margin: 0 auto;">
                    ...
                    <div class="card p-2 my-2">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" placeholder=" District here.." required="required">
