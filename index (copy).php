    ...
    <form action="" method="post" >
        <div class="container">
            <div class="row row-eq-height bg-gray-50">
               <div class="col-md-5 bg-warning p-4 my-5" style="background-image: url(tester.jpg);background-size: cover; background-repeat: no-repeat;";>

                    <div class="content ">
                         <div class="icon">
                             <img src="logo.png"></div>
                                <h2 class="title">
                                    <a style="color: #FFF;" href="">KFON <br> Internet -  A Basic Right</a>
                                </h2>
                                <p style="font-size:1.05rem; color: #FFF"> 
                               A Web Portal to provide a facility for the Government Institutions to register themselves for availing the kfonapp services.<br><br></p>            
                          </div>
    
                   </div>
                   <div class="col-md-6 pt-5 pb-5 bg-gray-50">
                    ...
                    <div class="card p-2 my-2">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <a data-toggle="modal" href="#exampleModal"><img src="/kfonapp/images/plus.gif" width="50" height="50"></a>
                                </div>
                            </div>
                            </div>
                        ...
                        <!-- <div class="form-group" >
                            <div class="col-md-12"><label>Number of LAN Connections Required</label></div>
                    
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="lanconnection" name="lanconnection" placeholder=" No. of LAN Connections here.."  maxlength="200" required="required">
                            </div>
                        </div> -->
                        </div>
                        ...
                        <div class="form-group" >
                            <div class="col-md-12" ><div class="one_half last" align="c">
                                <input type="submit" id="signup" name="signup" class="btn btn-warning" style="background-color: #011327; color: #FFF;" value="Submit"/>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <div class="modal-body">
        <form action="" method="post">
          ...
          <div style="display: flex;">
            ...
            <div>
              <p><br/></p>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a data-toggle="modal" href="#myModal2"><img src="/kfonapp/images/plus.gif" width="50" height="50" ></a>
            </div>
         </div>
        </form>
      </div>
        ...
        <input type="submit" value="Submit" id="submit" name="submit" class="btn btn-primary" style="margin: 0 auto;">
          ...
          <div class="modal" id="myModal2" data-backdrop="static">
            <div class="modal-dialog">
               <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title">Type Name</h4>
